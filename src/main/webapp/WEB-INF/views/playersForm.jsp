    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="numberOfTrainings">Number of trainings:</label><br>
                ...
                <div class="form-group">
                    ...
                    <form:select multiple="false" class="form-control" id="groupsId" itemValue="id" itemLabel="address" path="group"
                                 items="${groups}"/><br>
